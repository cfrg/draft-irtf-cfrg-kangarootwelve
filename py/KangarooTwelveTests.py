...
def printK12TestVectors():
    ...
    print("KangarooTwelve(M=pattern 0x00 to 0xFA for 8191 bytes, C=empty, 32 output bytes):")
    ...
    print("KangarooTwelve(M=pattern 0x00 to 0xFA for 8192 bytes, C=empty, 32 output bytes):")
    ...
    for c in [8189, 8190]:
        ...
        print("KangarooTwelve(M=pattern 0x00 to 0xFA for 8192 bytes, C=pattern 0x00 to 0xFA for {0:d} bytes, 32 output bytes):".format(c))
